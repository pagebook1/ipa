...
public class voice extends JPanel {
	...
	public voice() {
		...
		txtpnA.setText("<center>\r\n<h1>VOICE AND VOICELESS SOUND</h1>\r\n</center>\r\n<h3> All sounds are either voiced or voiceless. <b><i>Voiced sounds</i></b> are those that make our vocal chords vibrate when they are produced. Voiceless sounds are produced from air passing through the mouth at different points.</h3>\r\n<h1>Voiced sounds</h1>\r\n<h3>Technically speaking, a voiced sound is a strong sound in which the vocal chords vibrate. All vowel sounds and diphthongs are voiced sounds, but only some of the consonant sounds (/b/, /d/, /g/, /j/, /v/, /z/, /th/ as in that, and /w/ as in wail) are considered as such.</h3>\r\n<h1>Unvoiced or voiceless sounds</h1>\r\n<h3>Are weak and the vocal cords do not vibrate. There are eight unvoiced consonant sounds (/p/, /t/, /k/, /ch/, /f/, /s/, /th/ as in thin, and /hw/ as in whale).\r\nIf you put your fingers over your Adam\u2018s Apple (larynx) when you pronounce voiced sounds in isolation, you should be able to feel your vocal chords vibrate. When you pronounce an unvoiced or voiceless sound, you should not be able to feel a vibration.\r\nVoiced sounds take a little more effort to produce compared to their unvoiced counterparts.</h3>");

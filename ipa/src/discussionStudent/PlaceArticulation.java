...
public class PlaceArticulation extends JPanel {
	...
	public PlaceArticulation() {
		...
		lblNewLabel_4_1_1_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("Fricatives");
			}
		...
		lblNewLabel_4_1_1_2_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("Fricatives");
			}
		...
		lblNewLabel_4_2_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("Tap or Flap");
			}
		});
		...
		lblNewLabel_4_1_1_2_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("(Nasal) Stops");
			}
		});
...
//				new embedVideo("");
		...
		lblNewLabel_4_2_1_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("Approximants");
			}
		});
		...
		lblNewLabel_4_1_1_2_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("Approximants");
			}
		...
		lblNewLabel_4_1_1_1_1_1_1_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ToolTip1("Approximants");
			}
	...
	public void ToolTip1(String code)
	{
		switch(code)
		{
		case "(Oral) Stops":
			JOptionPane.showMessageDialog(null,
				    "Produced by forming a complete closure of the vocal tract.","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		case "(Nasal) Stops":
			JOptionPane.showMessageDialog(null,
				    "Produced by forming a complete closure of the oral cavity but with the velum lowered, allowing air to pass through the nasal cavity.","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		case "Tap or Flap":
			JOptionPane.showMessageDialog(null,
				    "Produced by a very quick movement of the tongue upward to make brief contact with the roof of the mouth, and then lowering to a neutral position. Flap: Involves a similar ballistic movement as a tap, but the tongue is first curled back in the mouth then makes contact with the post-alveolar region as it lowers.","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		case "Fricatives":
			JOptionPane.showMessageDialog(null,
				    "Produced by a tight narrowing of articulators creating turbulent airflow.","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		case "Affricate":
			JOptionPane.showMessageDialog(null,
				    "A single speech sound which combines a stop with a following fricative in rapid succession. Both are produced at the same place of articulation (i.e., are homorganic).","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		case "Approximants":
			JOptionPane.showMessageDialog(null,
				    "Sounds produced through a slight narrowing of the vocal tract, but not enough to cause noise or complete obstruction.","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		case "Lateral Approximant":
			JOptionPane.showMessageDialog(null,
				    "An approximant in which contact between two articulators is made in the center of the vocal tract but in which one or both sides of the tongue are pulled down slightly, allowing air to pass through without turbulence.","Description",JOptionPane.INFORMATION_MESSAGE);
			break;
		}
	}
}

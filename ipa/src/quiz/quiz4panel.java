...
public class quiz4panel extends JPanel {
	...
	String[] answers = {"Diphthongs","Vowels","Gliding","Narrow","Wide"};
	public quiz4panel() {
		...
		JRadioButton rdbtnAArticulationOrgans = new JRadioButton("A.\tNarrow");
		...
		JRadioButton rdbtnBLarynx_1 = new JRadioButton("B.\tWide");
		...
		JRadioButton rdbtnCResonators_1 = new JRadioButton("C.\tHeavy");
		...
		txtpntheseAreResponsible.setText("5. These are vowel sounds with drastically different articulations.");
		...
		JRadioButton rdbtnALarynx = new JRadioButton("A.\tNarrow");
		...
		JRadioButton rdbtnBPhonationOrgans = new JRadioButton("B.\tWide");
		...
		JRadioButton rdbtnCResonators = new JRadioButton("C.\tHeavy");
		...
		txtpnDespiteTheir.setText("4. It is comprised of vowel sounds that are similar in sound and similarly pronounced.");
		...
		JRadioButton rdbtnALungs = new JRadioButton("A.\tGliding");
		...
		JRadioButton rdbtnBBronchi = new JRadioButton("B.\tCentral");
		...
		JRadioButton rdbtnCGlottis = new JRadioButton("C.\tBack");
		...
		JRadioButton rdbtnDWindpipe = new JRadioButton("D.\tFront");
		...
		txtpntheyAreThe.setText("3. Dipththongs are sometimes referred to as __________ vowels. ");
		...
		JLabel lblNewLabel = new JLabel("Quiz 4: Diphthongs");
		...
		JRadioButton rdbtnALips = new JRadioButton("A.\tAlphabet");
		...
		JRadioButton rdbtnBPalate = new JRadioButton("B.\tVowels");
		...
		JRadioButton rdbtnDTongue = new JRadioButton("D.\tDiphthongs  ");
		...
		txtpnItHas.setText("2. These are a recurring component in syllables where sounds are produced by the vibration of air in the oral cavity.");
		...
		JLabel lblNewLabel_1 = new JLabel("1. When articulated, a vowel sound begins as one and blends into another.");
		lblNewLabel_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_1.setBounds(50, 11, 687, 93);
		question_1.add(lblNewLabel_1);
		
		JRadioButton rdbtnBronchi = new JRadioButton("A.\tAlphabet");
		...
		JRadioButton rdbtnBLarynx = new JRadioButton("B.\tVowels");
		...
		JRadioButton rdbtnCPharynx = new JRadioButton("C.\tConsonants");
